        ...
        <div className="flex items-center justify-between h-16 md:h-18">
          ...
          <nav className="hidden md:flex items-center gap-8">
            ...
            <div className="flex items-center gap-2 ml-2 pl-4 border-l border-gray-200">
              <a href="https://blog.naver.com/" target="_blank" rel="noopener noreferrer" aria-label="네이버 블로그" className="w-8 h-8 flex items-center justify-center rounded-full text-text-light hover:text-primary hover:bg-primary/10 transition-colors">
      ...
      {mobileOpen && (
        <nav className="md:hidden bg-white border-t border-gray-100 px-4 py-4 space-y-3">
          ...
          <div className="flex items-center gap-3 pt-3 border-t border-gray-100">
            <a href="https://blog.naver.com/" target="_blank" rel="noopener noreferrer" aria-label="네이버 블로그" className="w-9 h-9 flex items-center justify-center rounded-full text-text-light hover:text-primary hover:bg-primary/10 transition-colors">
              <svg className="w-4 h-4" viewBox="0 0 24 24" fill="currentColor"><path d="M16.273 12.845 7.376 0H0v24h7.727V11.155L16.624 24H24V0h-7.727v12.845z" /></svg>
            </a>
